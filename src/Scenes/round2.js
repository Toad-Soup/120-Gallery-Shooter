...
class round2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio("impact", "./Audio/impactMetal_heavy_003.ogg");
    ...
    create() {
        ...
        for (let i = 0; i < 2; i++) {
            ...
            let newDuck = this.add.sprite(x2, 380, "objectParts", "duck_target_white.png")
            let newStick = this.add.sprite(x2, 486, "objectParts", "stick_wood.png");
            newDuck.scorePoints = 5; 
            newDuck.hit = false;
            newDuck.speed = Phaser.Math.FloatBetween(1, 2.5);       //change the speed so they dont overlap
            newStick.speed = newDuck.speed;
            newDuck.direction = Phaser.Math.Between(0, 1) ? 1 : -1; // Random direction
            newStick.direction = newDuck.direction;
            newDuck.baseY = newDuck.y;
            newStick.baseY = newStick.y;

            my.sprite.sticks2.push(newStick);
            my.sprite.ducks2.push(newDuck);

            my.sprite.sticks2.push(stick);
            my.sprite.ducks2.push(duck);
        }
    ...
    update() {
        ...
        for (let duck of my.sprite.ducks2) {
        ...
        //moves the sticks
        for (let stick of my.sprite.sticks2) {
        ...
        */
        ...
        for(let bullet of my.sprite.bullet){
            ...
            let allShot = my.sprite.ducks2.every(duck => duck.hit);
